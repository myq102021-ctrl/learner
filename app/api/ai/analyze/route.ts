...
3. options：固定输出空数组。
4. answer：完整转写图片中的核心知识，作为背诵评分的标准参考答案；必须准确、清晰、有层次，不能填写“查看原图”。
5. solution：总结评分时必须覆盖的核心要点，各要点单独换行，不能只填写“请对照原图完成回忆”。
